...
- **Покрытие тестами:** Увеличение покрытия юнит-тестами бизнес-логики до 80%+ и внедрение нагрузочного тестирования, чтобы убедиться что приложение соответствует требованиям по RPS и SLI.
